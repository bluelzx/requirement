                	...
                	$.ajax({
								                ...
								                success: function (data)
								                {
								                    ...
								                    if (data=='true'){
								                    	...
								                    	$.ligerDialog.error('菜单'+$("#menuCode").val()+'已经存在,请选择其他菜单编号!')
								                     	return;
								                     }else{
								                     	$("#Button1").attr("disabled",true);
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
    <form name="form1" method="post" action="<%=path%>/saveSysMenu.do"   id="form1">
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                <td align="right" class="l-table-edit-td">菜单编号:</td>
                <td align="left" class="l-table-edit-td" style="width:160px"><input name="menuCode" type="text" id="menuCode" ltype="text" validate="{required:true}" /></td>
                <td align="left"></td>
                <td align="left"></td>
            </tr>
            ...
            <td align="left" class="l-table-edit-td" style="width:160px"><input name="text" type="text" id="text" ltype="text" validate="{required:true}" /></td>
            <td align="left"></td>
            <td align="left"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td" style="width:180px">
                	...
                	<input type="hidden" name="parentMenu" id="parentMenu"/>
                </td>
                <td align="left"></td>
                <td align="left"></td>
            </tr>
            ...
            <td align="left" class="l-table-edit-td" style="width:160px"><input name="menuOrder" type="text" id="menuOrder" ltype="text" validate="{required:true,minlength:3,maxlength:10}" /></td>
            <td align="left"></td>
            <td align="left"></td>
            </tr>
            <tr>
