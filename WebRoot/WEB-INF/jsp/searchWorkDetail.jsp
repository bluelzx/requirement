...
<html>
	<head>
		...
		<script type="text/javascript">
			$(function () {
				$("#workDate").ligerDateEditor({ showTime: false,format: "yyyyMMdd",  labelWidth: 100, labelAlign: 'left' });
			});
		 </script>
	</head>
	<body style="padding:6px; ">
	     <form name="form1" method="post" action="<%=path%>/searchWorkDetail.do"   id="form1">
	     	<table  cellpadding="0" cellspacing="0" class="l-table-edit">
	     		...
	     		<tr>
					...
					<td align="left" class="l-table-edit-td" style="width:160px">
						<input type="text" name="workDate" id="workDate" value="<c:out value="${workDate}"/>"/>
					</td>
	     		
	     		<td align="right" class="l-table-edit-td"></td>
                <td align="left" class="l-table-edit-td " style="width:160px">
                <input id="btnOK" type="submit" class="l-button" style="width:100px" value="查询"  />
                </td>
                </tr>
	     	</table>
	     </form>
