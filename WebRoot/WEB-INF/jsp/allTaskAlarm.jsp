        ...
        $.ajax({	type: 'POST',
            ...
            mygrid = $("#maingrid4").ligerGrid({
                ...
                { display: '预警类型', name: 'alarmType', width: 60,align:'center',
                 ...
                 { display: '预警值（天）', name: 'alermDays', align: 'center', width: 60 },
                 { display: '任务责任人', name: 'userName', align: 'center', width: 70 },
